...
Текущая очередь определяется [согласованным планом](docs/work_plan_ru.md): уточнение AWG lifecycle → #17 → #15 → необходимая часть #16 → автозапуск и приёмка #12; затем Android, оставшиеся задачи безопасности, восстановление wg и исследование P2P. Результаты инспекции: [обзор от 2026-09-18](docs/reviews/LanFabric_project_inspection_2026-09-18.md). Рабочий код остаётся версии 0.0.17; фиксация плана не означает исправления выявленных проблем.
