...
### P1 — сделать AWG устойчивым к cold boot
...
### P1/P2 — Android как полноценный L3-узел
...
### P2 — дополнительные security/destructive gates из test plan
...
### Research — direct LAN gaming без центрального data-path
