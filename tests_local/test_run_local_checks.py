...
class TestResultValidation(unittest.TestCase):
    ...
    def test_expected_versions_are_synchronized(self):
        self.assertEqual(checks.expected_module_version("vcli-admin"), "vcli-admin 0.0.18")
        self.assertEqual(checks.expected_module_version("vsrv-admin"), "vsrv-admin 0.0.18")
